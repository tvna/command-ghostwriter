...
- 機器に触れる前に、アース済みのラック筐体に触れるなどして体内の静電気を放電してください。特にカーペット敷きの部屋や乾燥した環境では静電気放電(ESD)による部品損傷のリスクが高まります。
```
...
- **床下空調(フリーアクセスフロア)**: 床下から冷気を供給する空調方式
